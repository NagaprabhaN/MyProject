<%@ Page Title="" Language="C#" MasterPageFile="~/Jobseeker/Jobseeker.Master" AutoEventWireup="true" CodeBehind="changePwd.aspx.cs" Inherits="Resource_Management.Jobseeker.changePwd" %>
...
<form id="form1" runat="server">
    <table style="width: 100%; color: #000099;">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btn_submit" runat="server" onclick="btn_submit_Click" ValidationGroup="Group" 
                    Text="SUBMIT" />
            </td>
            <td>
                &nbsp;</td>
